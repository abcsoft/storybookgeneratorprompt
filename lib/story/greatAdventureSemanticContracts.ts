...
export const GREAT_ADVENTURE_SEMANTIC_CONTRACTS: SceneSemanticContract[] = [
  ...
  },
  {
    ...
    continuityReferences: [],
    forbiddenSubstitutions: ["cropping any arm, hand, or fin at the frame edge", "Scout covered by the text panel inside the air bubble"],
    textSafeRegion: "top-right",
    subjectSafeRegion: "center",
  },
  {
  ...
  },
  {
    ...
    continuityReferences: [],
    forbiddenSubstitutions: ["Scout obscured by the text panel while splashing ashore", "the child's face covered by the text panel"],
    textSafeRegion: "bottom-left",
    subjectSafeRegion: "center",
  },
  {
  ...
  },
  {
    ...
    requiredAction: "the star rising out of the open treasure chest as the true treasure",
    requiredLocation: "the same crystal cave chamber as the preceding treasure-chest scenes",
    requiredProps: ["the open treasure chest"],
    continuityReferences: ["Must remain inside the crystal cave established by \"crystal-cave\"/\"treasure-chest-reach\"/\"chest-bursts-open\" — never relocate to a forest or outdoor path."],
    forbiddenSubstitutions: ["a forest, outdoor, or daylight setting", "a path or fireflies (the previous, now-removed forest imagery)"],
    textSafeRegion: "top-right",
  ...
  },
  {
    ...
    continuityReferences: [],
    forbiddenSubstitutions: ["the text panel covering most of the sleeping child's face or body", "Scout, the glowing star, or the window covered by the text panel"],
